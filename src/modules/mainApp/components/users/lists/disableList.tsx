...
export const DisableList = ()=>{
    ...
    const DisableUsersArray =
    OrderedUsers && OrderedUsers.filter((person:IUsersList) => person.flag === false);


  const renderListDisable =
    DisableUsersArray &&
    Object.values(DisableUsersArray).map((user:any, index) => {
